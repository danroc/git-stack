...
- Remove unused `CommitsAhead` method from `Client`.
- Remove unused `Graph.BranchesAt`, `Graph.IsAncestor` methods and `branchesAt` field.

## [0.2.0] - 2026-06-10

### Added

- Add `git-stack fold` to fold a branch into its stack parent, cascade descendants, and optionally delete the folded branch.
...
[Unreleased]: https://github.com/danroc/git-stack/compare/v0.2.1...HEAD
[0.2.1]: https://github.com/danroc/git-stack/compare/v0.2.0...v0.2.1
[0.2.0]: https://github.com/danroc/git-stack/compare/v0.1.1...v0.2.0
